...
`)])])],-1),q=n("h3",{id:"\u591A\u9009",tabindex:"-1"},[t("\u591A\u9009 "),n("a",{class:"header-anchor",href:"#\u591A\u9009","aria-hidden":"true"},"#")],-1),T=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
<\/script>
`},{highlight:b(()=>[O]),default:b(()=>[F(k)]),_:1}),q,F(c,{sourceCode:`<template><ClientOnly>
  <p>\u4F60\u559C\u6B22\u5403\u5565</p>
...
<\/script>
`},{highlight:b(()=>[$]),default:b(()=>[F(d)]),_:1}),j])}var J=y(w,[["render",P]]);export{I as __pageData,J as default};
