...
`)])])],-1),O=n("h2",{id:"\u81EA\u5B9A\u4E49\u6E32\u67D3",tabindex:"-1"},[t("\u81EA\u5B9A\u4E49\u6E32\u67D3 "),n("a",{class:"header-anchor",href:"#\u81EA\u5B9A\u4E49\u6E32\u67D3","aria-hidden":"true"},"#")],-1),R=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
<\/script>
`},{highlight:B(()=>[I]),default:B(()=>[h(l)]),_:1}),O,h(u,{sourceCode:`<template><ClientOnly>
...
<\/script>
`},{highlight:B(()=>[R]),default:B(()=>[h(i)]),_:1}),q])}var z=w($,[["render",T]]);export{P as __pageData,z as default};
